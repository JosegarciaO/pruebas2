class CertOrbe.Views.BaseView extends Backbone.View
  ...
  renderProgress: (schedule_id, callback) ->
    CertOrbe.Helpers.renderProgress(schedule_id, callback)
  ...
  renderErrors: (model, errors, alertsContainer = false) ->
    ...
    unless _.isEmpty(fullErrors)
      CertOrbe.Helpers.renderError(fullErrors, alertsContainer)
